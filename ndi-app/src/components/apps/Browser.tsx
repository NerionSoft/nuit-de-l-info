  ...
  return (
    <div className="h-full flex flex-col bg-[#1E1E1E] text-white">
      ...
      <div className="bg-[#2D2D2D] border-b border-white/10">
        ...
        <div className="h-9 flex items-center px-2 gap-1">
          <div className="flex items-center gap-2 px-3 py-1 bg-[#1E1E1E] rounded-t-lg">
            <div className="w-4 h-4 rounded-full bg-[#E95420]" />
            <span className="text-sm max-w-32 truncate">Ubuntu</span>
        ...
        <div className="h-10 flex items-center px-2 gap-2">
          ...
          <button
            onClick={() => handleNavigate('https://ubuntu.com')}
            className="p-1.5 rounded hover:bg-white/10"
          >
        ...
        <div className="h-8 flex items-center px-2 gap-2 border-t border-white/5">
          {bookmarks.map((bookmark) => (
            ...
            >
              <div className="w-4 h-4 rounded bg-[#E95420] flex items-center justify-center text-[10px]">
                {bookmark.title[0]}
              </div>
      ...
      <div className="flex-1 bg-[#FAFAFA] overflow-auto">
        {/* Simulated Ubuntu Page */}
        <div className="bg-[#2C001E] text-white">
          {/* Hero Section */}
          <div className="max-w-4xl mx-auto px-8 py-16 text-center">
            <h1 className="text-5xl font-bold mb-4">Ubuntu</h1>
            <p className="text-xl text-white/80 mb-8">
              The leading operating system for PCs, IoT devices, servers and the
              cloud
            </p>
            <div className="flex justify-center gap-4">
              <button className="px-6 py-3 bg-[#E95420] rounded-md font-medium hover:bg-[#C7410D] transition-colors">
                Download Ubuntu
              </button>
        ...
        <div className="max-w-4xl mx-auto px-8 py-12">
          ...
          <div className="grid grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 bg-[#E95420] rounded-full flex items-center justify-center">
            ...
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 bg-[#772953] rounded-full flex items-center justify-center">
            ...
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 bg-[#77216F] rounded-full flex items-center justify-center">
        ...
        <div className="bg-yellow-50 border-t border-yellow-200 px-8 py-4 text-center">
          <p className="text-yellow-800 text-sm">
            🎮 This is a simulated browser for the Ubuntu Simulator demo
          </p>
        </div>
      </div>
    </div>
