  ...
  const [lines, setLines] = useState<TerminalLine[]>([
    {
      id: 'welcome',
      type: 'output',
      content: `Welcome to Ubuntu 24.04 LTS (GNU/Linux 6.5.0-virtual x86_64)
...
`,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const prompt = `\x1b[32muser@ubuntu-simulator\x1b[0m:\x1b[34m${currentPath}\x1b[0m$ `;
  ...
  return (
    <div
      ref={containerRef}
      onClick={focusInput}
      className="h-full overflow-auto p-3 font-mono text-sm bg-[#300A24] text-white cursor-text"
    >
      {/* Output Lines */}
      {lines.map((line) => (
