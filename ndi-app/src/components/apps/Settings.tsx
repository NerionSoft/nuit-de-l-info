            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <button className="flex flex-col items-center gap-2 p-3 rounded-lg bg-white/10 ring-2 ring-[#E95420]">
                    <div className="w-16 h-10 bg-[#2C001E] rounded" />
              ...
              <div>
                ...
                <div className="flex gap-3">
                  {['#E95420', '#772953', '#77216F', '#3498db', '#27ae60'].map(
                    (color) => (
                      <button
                        key={color}
        ...
        return (
          <div className="p-6">
            ...
            <div className="flex items-start gap-6 mb-8">
              <div className="w-24 h-24 bg-gradient-to-br from-[#E95420] to-[#772953] rounded-full flex items-center justify-center">
                <span className="text-4xl font-bold">U</span>
              </div>
              <div>
                <h3 className="text-2xl font-bold">Ubuntu Simulator</h3>
