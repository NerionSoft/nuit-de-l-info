      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-12 bg-[#2D2D2D] border-b border-white/10 flex items-center px-3 gap-2">
          ...
          <div className="flex-1 flex items-center gap-1 px-3 py-1 bg-[#1E1E1E] rounded-md mx-2 overflow-x-auto">
            <button
              onClick={() => navigateTo('/')}
              className="hover:text-[#E95420] transition-colors"
            >
              /
            </button>
            {pathParts.map((part, index) => (
              <div key={index} className="flex items-center gap-1">
                ...
                <button
                  ...
                  className="hover:text-[#E95420] transition-colors text-sm"
                >
                  {part}
                </button>
              </div>
          ...
          {sortedItems.length === 0 ? (
            ...
            <div className="grid grid-cols-4 gap-4">
              {sortedItems.map((item) => (
                ...
                >
                  {item.type === 'directory' ? (
                    <Folder className="w-12 h-12 text-[#E95420]" />
                  ) : (
            ...
            <div className="flex flex-col gap-1">
              {sortedItems.map((item) => (
                ...
                >
                  {item.type === 'directory' ? (
                    <Folder className="w-5 h-5 text-[#E95420]" />
                  ) : (
