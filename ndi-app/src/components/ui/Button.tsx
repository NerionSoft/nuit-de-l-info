...
interface ButtonProps extends ComponentPropsWithoutRef<'button'> {
  variant?: 'primary' | 'secondary' | 'ghost' | 'ubuntu';
  size?: 'sm' | 'md' | 'lg';
}
    ...
    return (
      <button
        ...
        className={cn(
          ...
          // Variants
          variant === 'primary' && 'bg-[#F54E00] text-white hover:bg-[#E04500] focus:ring-[#F54E00]',
          ...
          variant === 'ubuntu' && 'bg-[#E95420] text-white hover:bg-[#C7410D] focus:ring-[#E95420]',
          // Sizes
