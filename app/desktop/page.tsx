      ...
      <div className="min-h-screen bg-[#0F172A] flex flex-col items-center justify-center">
        <div className="w-24 h-24 mb-8">
          <svg viewBox="0 0 100 100" className="animate-pulse">
            ...
            <circle cx="50" cy="50" r="35" fill="none" stroke="#3B82F6" strokeWidth="2" />
            <circle cx="50" cy="50" r="25" fill="none" stroke="#3B82F6" strokeWidth="2" />
            <circle cx="50" cy="50" r="10" fill="#3B82F6" />
          </svg>
        </div>
        <div className="text-white text-xl font-light">Linux Simulator</div>
  ...
  if (isMobile) {
    return (
      <div className="min-h-screen bg-[#0F172A] flex flex-col items-center justify-center p-8 text-center">
        <Monitor className="w-16 h-16 text-[#3B82F6] mb-6" />
        <h1 className="text-2xl font-bold text-white mb-4">
          Desktop requis
        </h1>
        <p className="text-white/70 max-w-md mb-8">
          Le simulateur Linux nécessite un écran plus large pour fonctionner correctement.
