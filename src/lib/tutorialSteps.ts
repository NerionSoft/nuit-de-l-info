...
export const tutorialSteps: TutorialStep[] = [
  ...
  // Étape 2: Découverte du bureau
  {
    id: 2,
    type: 'explore',
    title: 'Voici ton bureau Linux',
    subtitle: 'Comme Windows ou Mac, mais en mieux !',
    description:
      "Tu vois ces icônes ? Ce sont des raccourcis vers les applications. Le fond d'écran avec le dégradé bleu, c'est notre signature !",
    mascotMessage: {
  ...
  // Étape 13: Explorer les Settings
  {
    ...
    subtitle: 'Personnaliser Linux',
    description: 'Découvrons les paramètres pour personnaliser ton système !',
    mascotMessage: {
      text: "Une dernière chose ! Ouvre les Paramètres (Settings) pour voir comment personnaliser Linux. Double-clique sur l'icône !",
      mood: 'happy',
    },
    action: {
      type: 'double-click-icon',
  ...
  // ═══════════════════════════════════════════════════════════════
  // PARTIE 5: MONITORING SYSTÈME
  // ═══════════════════════════════════════════════════════════════

  // Étape 21: Ouvrir le Monitor
  {
    id: 21,
    type: 'action',
    title: 'Ouvre le Moniteur système',
    subtitle: 'Surveille ton système comme un pro',
    description:
      'Le Moniteur système te permet de voir en temps réel le CPU, la RAM, les processus et le réseau.',
    mascotMessage: {
      text: "Double-clique sur l'icône 'Monitor' ! C'est comme le Gestionnaire des tâches Windows, mais en plus complet ! 📊",
      mood: 'excited',
    },
    action: {
      type: 'double-click-icon',
      target: 'desktop-icon-system-monitor',
      description: 'Double-clique sur l\'icône Monitor',
      highlightSelector: '[data-app="system-monitor"]',
    },
  },

  // ═══════════════════════════════════════════════════════════════
  // PARTIE 6: FÉLICITATIONS
  // ═══════════════════════════════════════════════════════════════
  ...
  // Étape 22: Fin
  {
    ...
    description:
      'Tu maîtrises les bases de Linux, LibreOffice ET le monitoring système ! pwd, ls, cd, cat, mkdir, help, libreoffice... Continue à explorer. Le monde du logiciel libre est immense !',
    mascotMessage: {
      text: "BRAVO ! 🎉 Tu as terminé le tutoriel ! Tu connais les commandes de base, l'interface graphique, LibreOffice ET le monitoring système. Tu es prêt pour l'aventure Linux !",
      mood: 'celebrating',
    },
    icon: 'trophy',
  },
