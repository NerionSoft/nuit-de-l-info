...
\x1b[31m            .-/+oossssoo+/-.\x1b[0m               \x1b[1muser\x1b[0m@\x1b[1mlinux-sim\x1b[0m
\x1b[31m        \`:+ssssssssssssssssss+:\`\x1b[0m           -------------------------
\x1b[31m      -+ssssssssssssssssssyyssss+-\x1b[0m         \x1b[1mOS:\x1b[0m Linux Simulator x86_64
\x1b[31m    .ossssssssssssssssss\x1b[37mdMMMNy\x1b[31msssso.\x1b[0m       \x1b[1mHost:\x1b[0m Linux Simulator
...
\x1b[31m.ssssssss\x1b[37mdMMMNh\x1b[31mssssssssss\x1b[37mhNMMMd\x1b[31mssssssss.\x1b[0m   \x1b[1mTerminal:\x1b[0m Linux Simulator
...
`,
  ...
  uname: (args) => {
    if (args.includes('-a')) {
      return {
        output: 'Linux linux-sim 6.5.0-virtual #1 SMP PREEMPT_DYNAMIC x86_64 GNU/Linux',
      };
    }
    return { output: 'Linux' };
  },
...
Exemple: libreoffice --writer rapport.odt`,
  ...
  htop: () => ({
    output: `\x1b[32m✓ Lancement de System Monitor...\x1b[0m`,
    openApp: 'system-monitor' as AppType,
  }),

  'gnome-system-monitor': () => ({
    output: `\x1b[32m✓ Lancement de GNOME System Monitor...\x1b[0m`,
    openApp: 'system-monitor' as AppType,
  }),
};
