...
Astuce : Sur Linux, tu peux aussi ouvrir Writer depuis le terminal avec la commande :
$ libreoffice --writer
    ...
    <div className="h-full flex flex-col bg-[#F5F5F5]">
      ...
      <div className="flex-1 bg-[#808080] p-4 overflow-auto">
        ...
        <div className="max-w-3xl mx-auto bg-white shadow-lg min-h-[800px] relative">
          ...
          <div className="absolute inset-0 border-l-8 border-r-8 border-transparent pointer-events-none" />
          ...
          <textarea
            ...
            className="w-full h-full min-h-[800px] p-12 resize-none outline-none text-[#333] text-sm leading-relaxed font-serif cursor-text select-text relative z-10"
            spellCheck={false}
            autoFocus
            style={{ fontFamily: "'Liberation Serif', 'Times New Roman', serif", userSelect: 'text', WebkitUserSelect: 'text' }}
          />
        </div>
      </div>
