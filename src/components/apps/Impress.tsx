  ...
  if (isPresenting) {
    return (
      <div
        ...
        tabIndex={0}
      >
        <div className="w-full max-w-4xl aspect-[16/9] bg-gradient-to-br from-[#3B82F6] to-[#1E40AF] rounded-lg shadow-2xl p-12 flex flex-col">
    ...
    <div className="h-full flex flex-col bg-[#F5F5F5]">
      ...
      <div className="bg-[#E8E8E8] border-b border-[#C8C8C8] flex flex-wrap items-center px-2 py-1 gap-1">
        ...
        <button
          ...
          className="flex items-center gap-1 px-3 py-1 bg-[#3B82F6] hover:bg-[#C94010] text-white rounded transition-colors text-xs font-medium"
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-48 bg-[#F0F0F0] border-r border-[#C8C8C8] overflow-y-auto p-2">
          <div className="space-y-2">
            {slides.map((slide, index) => (
              ...
              >
                <div className="w-full h-full bg-gradient-to-br from-[#3B82F6] to-[#1E40AF] rounded p-2 flex flex-col">
        ...
        <div className="flex-1 bg-[#808080] p-6 flex flex-col items-center overflow-auto">
          ...
          {/* Current Slide */}
          <div className="w-full max-w-3xl aspect-[16/9] bg-gradient-to-br from-[#3B82F6] to-[#1E40AF] rounded-lg shadow-xl p-8 flex flex-col">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-1">
                {['Titre', 'Titre+Contenu', 'Deux colonnes', 'Vide', 'Image', 'Comparaison'].map((layout) => (
                  <button
                    key={layout}
                    className="aspect-[16/9] bg-white border border-[#C8C8C8] rounded text-[6px] hover:border-[#3B82F6] transition-colors"
                  >
                    {layout}
                  </button>
                ))}
