...
export function StepCard({ step }: StepCardProps) {
  ...
  if (step.type === 'intro') {
    return (
      ...
      >
        <div className="bg-[#0F172A] border border-[#3B82F6]/30 rounded-2xl p-8 max-w-lg w-full shadow-2xl relative">
          <button
          ...
          <div className="flex flex-col items-center text-center">
            ...
            {step.subtitle && (
              <p className="text-[#3B82F6] font-medium mb-4">{step.subtitle}</p>
            )}
  ...
  if (step.type === 'explore') {
    return (
      ...
      >
        <div className="bg-[#0F172A]/95 backdrop-blur-sm border border-blue-500/30 rounded-xl shadow-2xl overflow-hidden">
          {/* Header */}
  ...
  if (step.type === 'action' && phase === 'action') {
    return (
      <motion.div
        ...
        className="fixed right-4 bottom-20 z-40 w-[420px]"
      >
        <div className="bg-[#0F172A]/95 backdrop-blur-sm border border-[#3B82F6]/30 rounded-xl shadow-2xl overflow-hidden">
          {/* Header avec mascotte excitée */}
          <div className="bg-[#3B82F6]/20 px-4 py-3 border-b border-[#3B82F6]/30">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Mascot size="sm" mood={getMascotMood(step.mascotMessage)} />
                <div>
                  <span className="text-[#3B82F6] font-medium block">{step.title}</span>
                  <span className="text-white/50 text-xs">Étape {step.id}</span>
                </div>
              </div>
              <button
          ...
          <div className="p-4">
            ...
            {step.mascotMessage && (
              <div className="bg-[#3B82F6]/10 rounded-lg p-3 mb-4 border-l-4 border-[#3B82F6]">
                <p className="text-blue-200 text-sm italic">"{step.mascotMessage.text}"</p>
              </div>
            )}
            ...
            <motion.div
              ...
              className="bg-[#3B82F6]/20 rounded-lg p-4 border-2 border-dashed border-[#3B82F6]/50"
            >
              <div className="flex items-center gap-3">
                <motion.div
                  animate={{ x: [0, 5, 0] }}
                ...
                >
                  <MousePointer2 className="w-6 h-6 text-[#3B82F6]" />
                </motion.div>
                    ...
                    className={`
                      ...
                      ${showCorrectFeedback
                        ...
                        : showWrongFeedback
                          ...
                          : isSelected
                            ? 'bg-[#3B82F6]/30 border-2 border-[#3B82F6] text-white'
  ...
  if (phase === 'terminal') {
    return (
      <motion.div
        ...
        className="fixed right-4 bottom-20 z-40 w-[420px]"
      >
        <div className="bg-[#0F172A]/95 backdrop-blur-sm border border-green-500/30 rounded-xl shadow-2xl overflow-hidden">
          {/* Header */}
          ...
          <div className="p-4">
            ...
            {/* Commande */}
            <div className="bg-[#0F172A] rounded-lg p-4 font-mono relative">
              <div className="absolute -top-2 left-4 bg-[#0F172A] px-2 text-xs text-white/50">
                Commande
              </div>
  ...
  if (step.type === 'completion') {
    return (
      <motion.div
        ...
        className="fixed inset-0 z-40 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4"
      >
        <div className="bg-gradient-to-br from-[#0F172A] to-[#4A0D37] border border-[#3B82F6]/30 rounded-2xl p-8 max-w-lg w-full shadow-2xl relative overflow-hidden">
          {/* Sparkles */}
          ...
          <div className="relative flex flex-col items-center text-center">
            ...
            {step.subtitle && (
              <p className="text-[#3B82F6] font-medium mb-4 text-lg">{step.subtitle}</p>
            )}
            <p className="text-white/70 mb-8">{step.description}</p>
