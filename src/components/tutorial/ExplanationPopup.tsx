      ...
      {showExplanation && (
        ...
        >
          <motion.div
            ...
            className="bg-gradient-to-br from-[#0F172A] to-[#3D0D2B] border border-[#3B82F6]/40 rounded-2xl max-w-xl w-full shadow-2xl overflow-hidden"
          >
            ...
            <div className="p-6 space-y-5">
              ...
              {syntax && (
                <div className="bg-[#0F172A] rounded-lg p-4">
                  ...
                  <code className="text-[#3B82F6] font-mono">{syntax}</code>
                </div>
              )}
            ...
            <div className="px-6 py-4 bg-white/5 border-t border-white/10">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={handleContinue}
                className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-[#3B82F6] text-white rounded-lg font-medium hover:bg-[#2563EB] transition-colors"
              >
                Continuer
