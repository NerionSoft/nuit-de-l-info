...
export function ProgressBar() {
  ...
  return (
    <div
      className="
        group fixed top-0 left-1/2 -translate-x-1/2 z-50
        rounded-b-xl bg-[#0F172A]/95 backdrop-blur-sm border-b border-[#3B82F6]/30
        px-4 py-2
      "
    >

      {/* Version mini (visible hors hover) */}
      <div className="flex items-center justify-between group-hover:hidden">
        <span className="text-white/80 text-sm font-medium">
          Étape {currentStepId} / {tutorialSteps.length}
        </span>
      ...
      {/* Version complète (visible au hover) */}
