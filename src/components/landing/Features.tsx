  ...
  return (
    <section id="features" className="py-20 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <span className="inline-block px-4 py-1 bg-[#3B82F6]/10 text-[#3B82F6] rounded-full text-sm font-medium mb-4">
            Fonctionnalités
          </span>
          ...
          {features.map((feature) => {
            ...
            return (
              <motion.div
                ...
                className="group p-6 bg-[#FAFAFA] rounded-xl border border-[#E5E5E5] hover:border-[#3B82F6]/30 hover:shadow-lg transition-all duration-300"
              >
                <div
