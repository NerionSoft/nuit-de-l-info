...
const apps = [
  {
    ...
    preview: (
      <div className="bg-[#0F172A] rounded-lg p-3 font-mono text-xs">
        ...
        <div className="text-white/70">Hello Linux!</div>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    preview: (
      <div className="bg-[#2D2D2D] rounded-lg overflow-hidden">
        ...
        <div className="p-2 bg-[#0F172A] text-center text-white/80 text-xs">
          Linux Home
        </div>
      </div>
    ),
  },
  {
    ...
    preview: (
      <div className="bg-[#1E1E1E] rounded-lg p-2">
        ...
        <div className="flex gap-1">
          <div className="w-6 h-6 rounded bg-[#0F172A] ring-1 ring-[#3B82F6]" />
  ...
  return (
    <section id="apps" className="py-20 px-4 bg-[#EEEFE9]">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <span className="inline-block px-4 py-1 bg-[#1E40AF]/10 text-[#1E40AF] rounded-full text-sm font-medium mb-4">
            Applications
          </span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {apps.map((app, index) => {
            ...
            return (
              ...
              >
                {/* Preview */}
                <div className="p-4 bg-gradient-to-br from-[#0F172A] to-[#1E40AF]">
                  {app.preview}
                </div>
