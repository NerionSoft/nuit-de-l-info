    ...
    >
      {sidebarItems.map((item, index) => {
        ...
        return (
          ...
          >
            <div className="w-12 h-12 bg-white rounded-lg shadow-md border border-[#D0D1C9] flex items-center justify-center group-hover:border-[#3B82F6] group-hover:shadow-lg transition-all">
              <Icon className="w-5 h-5 text-[#6B6B6B] group-hover:text-[#3B82F6] transition-colors" />
            </div>
