...
export function Taskbar() {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 h-12 bg-[#0F172A]/95 backdrop-blur-sm border-t border-white/10 flex items-center justify-between px-2 z-50">
      {/* Activities Button */}
      <button
      ...
      {showAppMenu && (
        <motion.div
          ...
          exit={{ opacity: 0, y: 10 }}
          className="absolute bottom-14 left-2 bg-[#0F172A] rounded-lg shadow-2xl border border-white/10 p-4 grid grid-cols-3 gap-3"
        >
          {apps.map(({ app, label }) => {
            ...
            return (
              ...
              >
                <div className="w-10 h-10 flex items-center justify-center bg-gradient-to-br from-[#3B82F6] to-[#1E40AF] rounded-lg">
